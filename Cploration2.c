...
int quartile(char* name) {
    ...
    char str0[2] = {firstChar, '\0'};

    if (strcmp(str0, "A") >= 0 && strcmp(str0, "F") <= 0) {
        result = 1;
    } else if (strcmp(str0, "G") >= 0 && strcmp(str0, "L") <= 0) {
        result = 2;
    } else if (strcmp(str0, "M") >= 0 && strcmp(str0, "R") <= 0) {
        result = 3;
    } else if (strcmp(str0, "S") >= 0 && strcmp(str0, "Z") <= 0) {
        result = 4;
    }
